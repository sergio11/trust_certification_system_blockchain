...
@Slf4j
public class DisableCertificationAuthorityMemberHandler extends AbstractUserManagementHandler<DisableCertificationAuthorityMemberEvent, CertificationAuthorityMemberDisabledNotificationEvent> {
    ...
    public CertificationAuthorityMemberDisabledNotificationEvent onHandle(final DisableCertificationAuthorityMemberEvent event) throws RepositoryException {
        ...
        return new CertificationAuthorityMemberDisabledNotificationEvent(caMember.getWalletHash());
    }
}
