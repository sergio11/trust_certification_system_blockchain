...
@Slf4j
public class NewCertificationAuthorityMemberHandler extends AbstractUserManagementHandler<NewCertificationAuthorityMemberEvent> {
    ...
    @Override
    public AbstractNotificationEvent onHandle(final NewCertificationAuthorityMemberEvent event) throws RepositoryException {
