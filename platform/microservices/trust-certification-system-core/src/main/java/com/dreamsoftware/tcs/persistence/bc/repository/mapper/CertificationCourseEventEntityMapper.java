...
public abstract class CertificationCourseEventEntityMapper {
    ...
    @Mappings({
        ...
        @Mapping(expression = "java(com.dreamsoftware.tcs.persistence.bc.repository.entity.CertificationCourseEventTypeEnum.COURSE_DISABLED)", target = "type"),
    ...
    @Mappings({
        ...
        @Mapping(source = "event.log.transactionIndex", target = "transactionIndex"),
        @Mapping(source = "event.log.transactionIndexRaw", target = "transactionIndexRaw"),
        @Mapping(expression = "java(com.dreamsoftware.tcs.persistence.bc.repository.entity.CertificationCourseEventTypeEnum.COURSE_ENABLED)", target = "type"),
        @Mapping(source = "event._id", target = "courseId")
    })
    @Named("mapEventToEntity")
    ...
    @Mappings({
        ...
        @Mapping(source = "event.log.transactionIndex", target = "transactionIndex"),
        @Mapping(source = "event.log.transactionIndexRaw", target = "transactionIndexRaw"),
        @Mapping(expression = "java(com.dreamsoftware.tcs.persistence.bc.repository.entity.CertificationCourseEventTypeEnum.COURSE_REMOVED)", target = "type"),
        @Mapping(source = "event._id", target = "courseId")
    })
    @Named("mapEventToEntity")
    ...
    @Mappings({
        ...
        @Mapping(source = "event.log.transactionIndex", target = "transactionIndex"),
        @Mapping(source = "event.log.transactionIndexRaw", target = "transactionIndexRaw"),
        @Mapping(expression = "java(com.dreamsoftware.tcs.persistence.bc.repository.entity.CertificationCourseEventTypeEnum.COURSE_CREATED)", target = "type"),
        @Mapping(source = "event._id", target = "courseId")
    })
    @Named("mapEventToEntity")
