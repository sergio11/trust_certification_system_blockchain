...
public class NewCourseRegistrationRequestedMailRequestDTO extends AbstractMailRequestDTO {
     ...
     */
    @Builder
    public NewCourseRegistrationRequestedMailRequestDTO(final String id, final String name, final String email, final Locale locale) {
        super(email, locale);
        this.id = id;
        this.name = name;
    }
    ...
    public EmailTypeEnum getType() {
        return EmailTypeEnum.NEW_COURSE_REGISTRATION_REQUESTED;
    }
}
