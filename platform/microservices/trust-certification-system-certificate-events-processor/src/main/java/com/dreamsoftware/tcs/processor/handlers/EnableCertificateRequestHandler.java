...
@Slf4j
public class EnableCertificateRequestHandler extends AbstractCertificateManagementHandler<EnableCertificateRequestEvent, CertificateEnabledNotificationEvent> {
