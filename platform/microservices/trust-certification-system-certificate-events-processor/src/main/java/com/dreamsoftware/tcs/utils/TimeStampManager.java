...
/**
 * Class responsible for deal with Time Stamps. Time Stamp can be added when
 * Time Stamp Authority URL is available.
 */
public class TimeStampManager {
     ...
     */
    public TimeStampManager(String tsaUrl) throws NoSuchAlgorithmException, MalformedURLException {
        if (tsaUrl != null) {
     ...
     * @throws IOException
     */
    public CMSSignedData addSignedTimeStamp(CMSSignedData signedData) throws IOException, TSPException {
