...
public abstract class SupportEventBroadcaster<T extends AbstractBlockchainEventEntity> {

    private final Logger logger = LoggerFactory.getLogger(SupportEventBroadcaster.class);
