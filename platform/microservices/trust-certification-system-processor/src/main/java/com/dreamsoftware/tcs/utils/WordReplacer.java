...
public class WordReplacer {
    ...
    /**
     * Replaces all occurrences of a bookmark only in the text of the file with
    ...
    /**
     * Replaces all occurrences of a bookmark only in tables of the file with a
     * replacement string.
     *
     * @param bookmark word to replace.
     * @param replacement word of replacement.
    ...
    /**
     * Most of the time we want our template files untouched. Creates file from
     * path, saves the modified document to it and returns it.
     *
     * @param path filepath (dirs + filename).
     * @return modified file.
     * @throws Exception thrown if some issues while saving occur - mostly due
     * to unavailable file or permissions.
     */
    ...
    /**
     * Most of the time we want our template files untouched. Saves the modified
     * document to the given file and returns it.
     *
    ...
    private File saveToFile(File file) throws Exception {
        try (final FileOutputStream out = new FileOutputStream(file, false)) {
            document.write(out);
            document.close();
            return file;
        } catch (Exception e) {
