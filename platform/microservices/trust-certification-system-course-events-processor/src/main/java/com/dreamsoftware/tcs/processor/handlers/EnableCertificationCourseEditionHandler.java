...
@Slf4j
public class EnableCertificationCourseEditionHandler extends AbstractProcessAndReturnHandler<EnableCertificationCourseEditionEvent> {
     ...
     */
    @Override
    public AbstractEvent onHandle(final EnableCertificationCourseEditionEvent event) throws RepositoryException {
