...
@Slf4j
public class DisableCertificationCourseEditionHandler extends AbstractCourseManagementHandler<DisableCertificationCourseEditionEvent, CourseEditionDisabledNotificationEvent> {
