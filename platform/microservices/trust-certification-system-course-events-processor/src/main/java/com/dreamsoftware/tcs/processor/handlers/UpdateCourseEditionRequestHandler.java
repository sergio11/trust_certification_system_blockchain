...
@Slf4j
public class UpdateCourseEditionRequestHandler extends AbstractCourseManagementHandler<UpdateCertificationCourseEditionRequestEvent, CertificationCourseEditionUpdatedNotificationEvent> {
