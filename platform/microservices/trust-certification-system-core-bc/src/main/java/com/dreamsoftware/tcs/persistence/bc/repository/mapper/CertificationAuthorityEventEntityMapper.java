...
public abstract class CertificationAuthorityEventEntityMapper {
    ...
    @Mappings({
        ...
        @Mapping(expression = "java(com.dreamsoftware.tcs.persistence.bc.repository.entity.CertificationAuthorityEventTypeEnum.CA_CREATED)", target = "type")
    })
    ...
    @Mappings({
        ...
        @Mapping(source = "event.log.transactionIndex", target = "transactionIndex"),
        @Mapping(source = "event.log.transactionIndexRaw", target = "transactionIndexRaw"),
        @Mapping(expression = "java(com.dreamsoftware.tcs.persistence.bc.repository.entity.CertificationAuthorityEventTypeEnum.CA_REMOVED)", target = "type")
    })
    @Named("mapEventToEntity")
    ...
    @Mappings({
        ...
        @Mapping(source = "event.log.transactionIndex", target = "transactionIndex"),
        @Mapping(source = "event.log.transactionIndexRaw", target = "transactionIndexRaw"),
        @Mapping(expression = "java(com.dreamsoftware.tcs.persistence.bc.repository.entity.CertificationAuthorityEventTypeEnum.CA_ENABLED)", target = "type")
    })
    @Named("mapEventToEntity")
    ...
    @Mappings({
        ...
        @Mapping(source = "event.log.transactionIndex", target = "transactionIndex"),
        @Mapping(source = "event.log.transactionIndexRaw", target = "transactionIndexRaw"),
        @Mapping(expression = "java(com.dreamsoftware.tcs.persistence.bc.repository.entity.CertificationAuthorityEventTypeEnum.CA_DISABLED)", target = "type")
    })
    @Named("mapEventToEntity")
